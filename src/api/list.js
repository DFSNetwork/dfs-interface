...
export function get_table_rows(params) {
  return new Promise((resolve, reject) => {
    const host = getHost();
    axios.post(`${host}/v1/chain/get_table_rows`, JSON.stringify(params)).then(
      (res) => {
...
export function get_swap_summary() {
  return new Promise((resolve, reject) => {
    axios.get("https://api.yfc.one/dfs/swap/summary2").then(
      (res) => {
        let result = Object.assign(res.data, {});
        resolve({ status: res.status === 200, result });
      },
...
export function get_swap_counter() {
  return new Promise((resolve, reject) => {
    axios.get("https://api.yfc.one/dfs/swap/counter").then(
      (res) => {
        let result = Object.assign(res.data, {});
        resolve({ status: res.status === 200, result });
      },
...
export function get_all_orders() {
  return new Promise((resolve, reject) => {
    ...
    axios.get("https://api.yfc.one/pddex2/orders", JSON.stringify(params)).then(
      (res) => {
        let result = Object.assign(res.data, {});
        resolve({ status: res.status === 200, result });
      },
...
export function get_markets() {
  return new Promise((resolve, reject) => {
    axios
      .get("https://api.yfc.one/dfs/common/markets", {
        timeout: 5000,
      })
      .then(
        (res) => {
...
export function get_price() {
  return new Promise((resolve, reject) => {
    axios.get("https://api.yfc.one/dfs/common/get_price").then(
      (res) => {
...
export function get_currency_stats(params) {
  return new Promise((resolve, reject) => {
    const host = getHost();
    axios
      .post(`${host}/v1/chain/get_currency_stats`, JSON.stringify(params))
      .then(
        (res) => {
          let result = Object.assign(res.data, {});
          resolve({ status: res.status === 200, result });
...
export function get_currency_balance(params) {
  return new Promise((resolve, reject) => {
    const host = getHost();
    axios
      .post(`${host}/v1/chain/get_currency_balance`, JSON.stringify(params))
      .then(
        (res) => {
          // let result = Object.assign(res.data, {});
          let result = res.data;
          if (!result.length) {
            result = [
              `${Number(0).toFixed(params.decimal || 4)} ${params.symbol}`,
            ];
          }
...
export function get_market_info(params) {
  return new Promise((resolve, reject) => {
    ...
    axios.get("https://api.yfc.one/dfs/apy/apy-by-mid", { params }).then(
      (res) => {
        const result = res.data;
        resolve({ status: res.status === 200, result });
      },
...
export function get_swap_lasters(params) {
  return new Promise((resolve, reject) => {
    axios.get("https://api.yfc.one/dfs/swap/marketlog", { params }).then(
      (res) => {
        const result = res.data;
        resolve({ status: res.status === 200, result });
      },
...
export function get_account(name) {
  return new Promise((resolve, reject) => {
    ...
    axios.post(`${host}/v1/chain/get_account`, JSON.stringify(params)).then(
      (res) => {
        let result = Object.assign(res.data, {});
        // console.log(result)
        resolve({ status: res.status === 200, result });
...
export function reg_newaccount(obj) {
  return new Promise((resolve, reject) => {
    ...
    axios
      .post(`https://api.yfc.one/account/newaccount`, JSON.stringify(params))
      .then(
        (res) => {
          let result = Object.assign(res.data, {});
          console.log(result);
...
export function pushFreeCpu(params) {
  return new Promise((resolve, reject) => {
    ...
    axios.post(`https://api.yfc.one/account/pushaction`, params).then(
      (res) => {
