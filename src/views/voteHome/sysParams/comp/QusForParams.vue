<template>
  <div class="qus">
    <div class="qusTitle flexb">
      ...
      <img @click="showRules = !showRules" class="tipIcon" src="https://resource1.dfs.land/icon/tips_icon_btn.svg" alt="">
    </div>
    ...
    <div class="options">
      <div class="item flexa" v-for="(v, i) in options" :key="i" @click="handleCheck(v.mid)"
        ...
        <div class="checkDiv flexc">
          <img v-if="check === v.mid" class="checkedImg" src="https://resource1.dfs.land/icon/checked.png" alt="">
        </div>
        <div class="main">
          <div class="">
