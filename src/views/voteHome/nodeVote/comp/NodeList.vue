      ...
      <div class="list flexa" v-for="(item, index) in lists" :key="index"
        ...
        <div class="main">
          ...
          <div class="tip data flexb" v-if="act !== 4">
            <div class="flexa dinReg">
              <span class="voteIcon flexc">
                <img class="small" src="https://resource1.dfs.land/icon/money.png" alt="">
              </span>
          ...
          <div class="tip data flexb" v-if="act !== 4">
            ...
            <div class="flexa dinReg">
              <img class="voteIcon" src="https://resource1.dfs.land/icon/earth.png" alt="">
        ...
        <div class="checkBoxDiv flexc">
          <div class="checkBox flexc" :class="{'isChecked': item.isChecked}">
            <img v-if="item.isChecked" class="checkedImg" src="https://resource1.dfs.land/icon/checked.png" alt="">
          </div>
        </div>
      </div>
    </van-list>
...
export default {
  ...
  data() {
    return {
      voteDefaultImg: 'https://resource2.dfs.land/coin/tagtokenmain-tag.png',
      isChecked: false,
      lists: [],
      rankLists: [],
      myVoteList: [],
