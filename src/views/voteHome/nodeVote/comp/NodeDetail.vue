  ...
  <div class="voteDetail">
    ...
    <div class="mylist">
      ...
      <div class="tip data flexb">
        ...
        <div class="flexa">
          <img class="coin" src="https://resource1.dfs.land/svg/earth.svg">
    ...
    <div class="minerLists">
      ...
      <template v-for="(item, index) in minersArr">
        <div class="list" :class="{'page1': page === 1}" :key="index">
          ...
          <label class="rankImg" v-if="page === 1 && index < 3"><img :src="`https://resource1.dfs.land/rank/rank${index + 1}.png`" alt=""></label>
        </div>
      </template>
