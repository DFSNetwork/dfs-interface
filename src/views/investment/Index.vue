<template>
  <div class="investment">
    <img class="banner" src="https://cdn.jsdelivr.net/gh/defis-net/material2/dfs/investment.png">
    <div class="tools flexb">
      <div class="item" @click="handleTo('inverstRank')">
        <img src="https://cdn.jsdelivr.net/gh/defis-net/material2/dfs/ranking.png" alt="">
        <div>{{ $t('invest.rank') }}</div>
      </div>
      <div class="item" @click="handleTo('myInverst')">
        <img src="https://cdn.jsdelivr.net/gh/defis-net/material2/dfs/fixed.png" alt="">
        <div>{{ $t('invest.myInvest') }}</div>
      </div>
      <div class="item" @click="handleTo('inverstRules')">
        <img src="https://cdn.jsdelivr.net/gh/defis-net/material2/dfs/news.png" alt="">
