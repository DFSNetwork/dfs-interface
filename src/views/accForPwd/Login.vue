    ...
    <div class="otherLogin">
      ...
      <div class="flexb pro">
        <div class="logoItem" @click="handleLoginOther('tp')">
          <img class="logo" src="https://resource2.dfs.land/dfs/tp_logo.png">
          <div>TP</div>
        </div>
        <div class="logoItem" @click="handleLoginOther('mykey')">
          <img class="logo" src="https://resource2.dfs.land/dfs/mykey_logo.png">
          <div>Mykey</div>
        </div>
        <div class="logoItem" @click="handleLoginOther('start')">
          <img class="logo" src="https://resource2.dfs.land/dfs/start_logo.png">
          <div>Start</div>
        </div>
      </div>
    </div>
