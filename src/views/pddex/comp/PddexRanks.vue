      ...
      <div class="subTitle flexb">
        <div class="flexa">
          <span class="flexa" @click="handleSortVol">
            ...
            <img class="sortCoin" v-if="sortVol === 0" src="https://resource2.dfs.land/pddex/sort_default.png" alt="">
            <img class="sortCoin" v-else-if="sortVol === 1" src="https://resource2.dfs.land/pddex/sort_down.png" alt="">
            <img class="sortCoin" v-else src="https://resource2.dfs.land/pddex/sort_up.png" alt="">
          </span>
          <span class="flexa" @click="handleSortPools">
            <span>{{ $t('pddex.pools') }}</span>
            <img class="sortCoin" v-if="sortPools === 0" src="https://resource2.dfs.land/pddex/sort_default.png" alt="">
            <img class="sortCoin" v-else-if="sortPools === 1" src="https://resource2.dfs.land/pddex/sort_down.png" alt="">
            <img class="sortCoin" v-else src="https://resource2.dfs.land/pddex/sort_up.png" alt="">
          </span>
          <span class="flexa" @click="handleSortApy">
            <span>{{ $t('pddex.apys') }}</span>
            <img class="sortCoin" v-if="sortApy === 0" src="https://resource2.dfs.land/pddex/sort_default.png" alt="">
            <img class="sortCoin" v-else-if="sortApy === 1" src="https://resource2.dfs.land/pddex/sort_down.png" alt="">
            <img class="sortCoin" v-else src="https://resource2.dfs.land/pddex/sort_up.png" alt="">
          </span>
        </div>
        <div class="rateDivS">
          <span class="flexa" @click="handleSortPrice">
            ...
            <img class="sortCoin noMargin" v-if="sortPrice === 0" src="https://resource2.dfs.land/pddex/sort_default.png" alt="">
            <img class="sortCoin noMargin" v-else-if="sortPrice === 1" src="https://resource2.dfs.land/pddex/sort_down.png" alt="">
            <img class="sortCoin noMargin" v-else src="https://resource2.dfs.land/pddex/sort_up.png" alt="">
          </span>
        </div>
        <div class="rateDiv">
          <span class="flexa" @click="handleSortRate">
            <span>{{ $t('pddex.rate') }}</span>
            <img class="sortCoin noMargin" v-if="sortRate === 0" src="https://resource2.dfs.land/pddex/sort_default.png" alt="">
            <img class="sortCoin noMargin" v-else-if="sortRate === 1" src="https://resource2.dfs.land/pddex/sort_down.png" alt="">
            <img class="sortCoin noMargin" v-else src="https://resource2.dfs.land/pddex/sort_up.png" alt="">
          </span>
        </div>
      </div>
      ...
      >
        <div class="rankList" v-if="active === 0">
          ...
          <div class="noDate tip" v-if="!followList.length && getLike">
            <img class="noDataPng" src="https://resource1.dfs.land/noData/noStar.png" alt="">
