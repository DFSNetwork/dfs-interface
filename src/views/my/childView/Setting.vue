<template>
  <div class="setting">
      ...
      <div class="flexa">
        ...
        <div>
          ...
          <div class="tip flexa">
            ...
            <!-- <img class="copy" src="https://resource2.dfs.land/dfs/copy.png"> -->
          </div>
        </div>
      </div>
      <img class="right" src="https://resource1.dfs.land/icon/itemRight.png">
    </div>
    ...
    <div class="exportPrivate flexb"
      ...
      <div class="flexa">
        <img class="icon" src="https://resource2.dfs.land/dfs/exportPrivite1.png" alt="">
    ...
    <div class="exportPrivate flexb"
      ...
      v-if="wallet === 'newwallet' && account.name">
      <div class="flexa">
        <img class="icon" src="https://resource2.dfs.land/dfs/password1.png" alt="">
    ...
    <!-- <div class="exportPrivate flexb" @click="showUpAcc = true"> -->
      <div class="flexa">
        <img class="icon" src="https://resource2.dfs.land/dfs/upAcc1.png" alt="">
