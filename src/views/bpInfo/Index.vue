<template>
  <div class="bpInfo">
    <div class="banner">
      <img class="banImg" src="https://resource1.dfs.land/bpInfo/banner1.png" alt="">
      <div class="typeDiv">
        <div class="flexb">
          <div class="flexa">
            <img src="https://resource1.dfs.land/bpInfo/type2.png" alt="">
            <span>出块出得好</span>
          </div>
          <div class="flexc">
            <img src="https://resource1.dfs.land/bpInfo/type2.png" alt="">
        ...
        <div class="flexb item">
          <div class="flexa">
            <img src="https://resource1.dfs.land/bpInfo/type3.png" alt="">
            <span>社区超给力</span>
          </div>
          <div class="flexc">
            <img src="https://resource1.dfs.land/bpInfo/type4.png" alt="">
            <span>技术猛如虎</span>
          </div>
        </div>
      </div>
...
.bpInfo{
  // background-image: url('https://resource1.dfs.land/bpInfo/banner.png');
