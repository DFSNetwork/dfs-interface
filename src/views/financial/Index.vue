<template>
  <div class="financial">
    <div class="banner">
      <img v-if="$store.state.app.language === 'en'" src="https://resource1.dfs.land/financial/financial2-en.png" alt="">
      <img v-else src="https://resource1.dfs.land/financial/financial2.png" alt="">
