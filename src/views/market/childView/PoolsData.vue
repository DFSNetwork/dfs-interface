        ...
        <div class="content">
          ...
          <div class="symbol flexa">
            <div class="coinInfo flex">
              <div class="coinImg"><img width="100%" :src="item.sym0Data.imgUrl" :onerror="$errorImg"></div>
              <div>
            ...
            <div class="add">+</div>
            <div class="coinInfo flex">
              <div class="coinImg"><img width="100%" :src="item.sym1Data.imgUrl" :onerror="$errorImg"></div>
              <div>
...
export default {
  ...
  methods: {
    handleGetSrc(mid, index) {
      if (index <= 21) {
        // https://storied-crepe-e5e65c.netlify.app/art/levels/1.png
        return `https://storied-crepe-e5e65c.netlify.app/art/levels/${index + 1}.png`
      } else {
        return ''
      }
    },
