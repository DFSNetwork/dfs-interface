  ...
  <div class="audio">
    <div v-for="(v, i) in src" :key="i">
      ...
      <div class="audioStyle flexa" @click.stop="handleToPlay(i)">
        <img v-if="duration && duration[i] ? !duration[i].isPlaying : true" class="img" src="https://resource1.dfs.land/icon/audio.png" alt="">
        <img v-else class="img" src="https://resource1.dfs.land/icon/audio.gif" alt="">
