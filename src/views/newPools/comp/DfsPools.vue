...
import { getApy, getReward } from '@/views/dfsMine/dfsMine'
...
export default {
  ...
  computed: {
    ...
    dfsApy() {
      const allBal = {
        dfsPoolsBal: parseFloat(this.poolsBal)
      }
      const swapBal = {
        dfsSwapBal: parseFloat(this.swapBal)
      }
      const apy = getApy(allBal, swapBal,'dfs');
